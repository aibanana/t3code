 ...
 *
 * This service owns Claude Agent SDK semantics and emits Claude provider events.
 * It does not perform cross-provider routing, shared event fan-out, or checkpoint
 * orchestration.
 *
